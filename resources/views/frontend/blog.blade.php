        ...
        <div class="row">
            <div class="col-md-12">
                <div class="mx-auto text-center mb-5" style="max-width: 500px;">
                    ...
                    <h1 class="display-5">Blog Details</h1>
                </div>
            </div>
        </div>
        <div class="row g-5">
                ...
                <div class="row g-5">
                    <div class="col-md-6">
                        <div class="blog-item position-relative overflow-hidden">
                            <img class="img-fluid" src="{{asset('frontend/img/blog-9.png')}}" alt="">
            ...
            <div class="col-lg-4">
                ...
                <div class="mb-5">
                    <div class="input-group">
                        <input type="text" class="form-control p-3 bdr-rdus-ryt" placeholder="Keyword">
                ...
                <div class="mb-5">
                    ...
                    <div class="d-flex flex-column justify-content-start bg-primary p-4 bdr-rdus">
                ...
                <div class="mb-5">
                    ...
                    <div class="bg-primary p-4 bdr-rdus">
                        <div class="d-flex overflow-hidden mb-3">
                            <img class="img-fluid flex-shrink-0 bdr-rdus-ryt" src="{{asset('frontend/img/blog-9.png')}}" style="width: 75px;" alt="">
                            <a href="" class="d-flex align-items-center bg-white text-dark fs-5 fw-bold px-3 mb-0 bdr-rdus-lft">Lorem ipsum dolor sit amet elit
                            </a>
                        </div>
                        <div class="d-flex overflow-hidden mb-3">
                            <img class="img-fluid flex-shrink-0 bdr-rdus-ryt" src="{{asset('frontend/img/blog-2.jpg')}}" style="width: 75px;" alt="">
                            <a href="" class="d-flex align-items-center bg-white text-dark fs-5 fw-bold px-3 mb-0 bdr-rdus-lft">Lorem ipsum dolor sit amet elit
                            </a>
                        </div>
                        <div class="d-flex overflow-hidden mb-3">
                            <img class="img-fluid flex-shrink-0 bdr-rdus-ryt" src="{{asset('frontend/img/blog-3.jpg')}}" style="width: 75px;" alt="">
                            <a href="" class="d-flex align-items-center bg-white text-dark fs-5 fw-bold px-3 mb-0 bdr-rdus-lft">Lorem ipsum dolor sit amet elit
                            </a>
                        </div>
                        <div class="d-flex overflow-hidden mb-3">
                ...
                <!-- Image Start -->
                <div class="mb-5">
                    <img src="{{asset('frontend/img/blog-9.png')}}" alt="" class="img-fluid rounded bdr-rdus">
                </div>
                <!-- Image End -->
                ...
                <div>
                    ...
                    <div class="bg-primary text-center text-white bdr-rdus" style="padding: 30px;">
