                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="footer-margin">
                        ...
                        <div class="d-flex mt-4">
                            <a class="btn btn-secondary btn-square rounded-circle me-2" href="{{$contact->shop_tw}}" target="_blank"><i class="fab fa-twitter"></i></a>
                            <a class="btn btn-secondary btn-square rounded-circle me-2" href="{{$contact->shop_fb}}" target="_blank"><i class="fab fa-facebook-f"></i></a>
                            <a class="btn btn-secondary btn-square rounded-circle me-2" href="{{$contact->shop_li}}" target="_blank"><i class="fab fa-linkedin-in"></i></a>
                            <a class="btn btn-secondary btn-square rounded-circle" href="{{$contact->shop_in}}" target="_blank"><i class="fab fa-instagram"></i></a>
                        </div>
                    </div>    
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="footer-margin">
                        ...
                        <div class="d-flex flex-column justify-content-start">
                            @if(session()->get('langu')=='ar')
                              ...
                              <a class="text-white mb-sm-2 mb-1" href="{{route('index')}}"><i class="bi bi-arrow-left text-white footer-icon"></i>@lang('msg.Home')</a>
                            <a class="text-white mb-sm-2 mb-1" href="{{route('about')}}"><i class="bi bi-arrow-left text-white footer-icon"></i>@lang('msg.AboutUs')</a>
                            <a class="text-white mb-sm-2 mb-1" href="{{route('shop_market')}}"><i class="bi bi-arrow-left text-white footer-icon"></i>@lang('msg.ShopMarketplace')</a>
                            ...
                            <a class="text-white" href="{{route('contact_us')}}"><i class="bi bi-arrow-left text-white footer-icon"></i>@lang('msg.Contact')</a>
                ...
                <div class="col-lg-2 col-md-6 col-sm-6 col-12">
                    <div class="footer-margin">
                        ...
                        <div class="d-flex flex-column justify-content-start">
                            ...
                            <a class="text-white mb-sm-2 mb-1" href="{{route('deliveryarea')}}"><i class="bi bi-arrow-left text-white footer-icon"></i>@lang('msg.DeliveryArea')</a>
                    ...
                    <div class="news-letter p-2 bdr-rdus">
                        ...
                        <form action="{{route('subscribe')}}" method="POST">
                            ...
                            <div class="input-group">
                                <input type="email" name="email" class="form-control border-white p-2 w-100 bdr-rdus " placeholder= @lang('msg.YourEmail') style="border-top-right-radius: 9px;
                                border-bottom-right-radius: 9px;" required>
                                <button class="btn btn-primary mt-3 bdr-rdus subscribe-btn" style="border-top-left-radius: 9px;
    ...
    <div class="container-fluid bg-dark text-white py-4">
        <div class="container text-center">
            <p class="mb-0">&copy; @lang('msg.AllRights')</p>
        </div>
    </div>
    <!-- Footer End -->
