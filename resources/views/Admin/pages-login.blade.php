...
<body>
  ...
  <main>
        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-lg-5 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                <div class="card-head">
                  <div class="pt-4" style="text-align:center;width: 100%;">
                    <a href="index.php" class="logo align-items-center w-auto">
                      <img src="{{asset('Backend/img/new-logo.png')}}" alt="" class="img-fluid adminlogo">
                    </a>
                  </div><!-- End Logo -->
                </div>
                <div class="card-body">
                  <div class="pb-2">
                    <h5 class="card-title text-center pb-0 fs-4 pt-0">Login to Admin Account</h5>
                  ...
                  <form class="row g-3 needs-validation" novalidate method="post" action="{{route('admin.siginin')}}">
                     @csrf
                    <div class="col-12">
    ...
    top: 58%;cursor: pointer;"></i>
                    ...
                    <div class="col-12">
                      <button class="btn btn-primary w-100" type="submit" style="background: #198754; border: none;">Login</button>
                    </div>
                    <div class="col-12">
