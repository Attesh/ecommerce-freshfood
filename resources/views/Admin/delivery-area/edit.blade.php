        ...
        <div class="col-lg-12">
          <div class="card">
            ...
            <ul class="nav nav-tabs nav-tabs-bordered profilenav">
              ...
              <!-- Multi Columns Form -->
              <form class="row g-3" method="POST" action="{{route('zipcode.update')}}">
			  @csrf
        <input type="hidden" name="id" value="{{$area->id}}">
                <div class="col-md-6">
                  <label for="inputState" class="form-label">Title</label>
                  <input type="text" class="form-control" id="inputName5" name="title" value="{{$area->title}}">
                </div>
</div>
...
<div class="col-md-6">
                ...
                <div class="col-md-6 mt-3">
                  ...
                  <input type="number" class="form-control" id="inputName5" name="zipcode" value="{{$area->zipcode}}">
                </div>
                 <div class=" mt-3">
