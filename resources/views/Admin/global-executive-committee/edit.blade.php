...
@include('Admin.include.asidebar')
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item">Global Executive Committee</li>
          <li class="breadcrumb-item active">Global Executive Committee</li>
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Edit Global Executive Committee</h5>

              <!-- Multi Columns Form -->
              <form class="row g-3" method="POST" action="{{route('global.update')}}" enctype="multipart/form-data">
			  @csrf
