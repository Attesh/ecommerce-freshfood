        ...
        <div class="col-xl-4">
          ...
          <div class="card">
            ...
            @if(Auth::guard('admin')->user()->image=='')
              <img src="{{asset('Backend/img/dummy_image.jpg')}}" class="rounded-circle" alt="Profile">
            @endif
            @if(Auth::guard('admin')->user()->image)
                  ...
                  <input type="hidden" name="id" value="{{Auth::guard('admin')->user()->id}}">
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        @if(Auth::guard('admin')->user()->image=='')
                          <img src="{{asset('Backend/img/dummy_image.jpg')}}" class="img-fluid img-thumbnail rounded-circle" id="output-img" style="width: 120px; height: 120px;" alt="Profile">
                        @endif
                        @if(Auth::guard('admin')->user()->image)
...
Password  is Required
                            ...
                            <div class="pt-1 mb-2 mt-4">
                                <button class="btn btn-info btn-lg btn-block loginbutn w-100" id ="resetsumittButton" type="button">Change
                                    Password</button>
                            </div>
                  </form>
