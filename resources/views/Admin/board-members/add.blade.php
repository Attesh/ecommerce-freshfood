        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              ...
              <!-- Multi Columns Form -->
              <form class="row g-3" method="POST" action="{{route('board-members.store')}}" enctype="multipart/form-data">
			  @csrf
        <div class="col-md-4">
          ...
          <select id="inputState" class="form-select" name="category_id">
            ...
            <div class="row" id="ipapprove">
              <div class="col-md-4">
                  ...
                  <input type="text" class="form-control" id="inputName5" name="board_members[0][name]">
                </div>
                <div class="col-md-4">
                  <label for="inputState" class="form-label">Title</label>
                  <input type="text" class="form-control" id="inputName5" name="board_members[0][title]">
                </div>
                <div class="col-md-4">
