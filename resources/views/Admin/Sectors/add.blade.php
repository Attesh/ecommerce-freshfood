            ...
            <div class="card-body">
              ...
              <ul class="nav nav-tabs nav-tabs-bordered profilenav">
                                    ...
                                    <div class="tab-content pt-2">
                                       ...
                                       <form class="row g-3" method="POST" action="{{route('sector.store')}}">
@csrf
                <div class="col-md-6">
                  <label for="inputState" class="form-label">City</label>
                  <select id="inputState" class="form-select" name="city_id" required>
                ...
                <div class="col-md-6">
                  <label for="inputState" class="form-label">Sector</label>
                  <input type="text" class="form-control" id="inputName5" name="sector_ar" required>
                </div></div>
