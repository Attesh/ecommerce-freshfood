      ...
      <div class="col-lg-12">
        ...
        <div class="card">
          <div class="card-header d-flex">
            ...
            <a href="{{route('gallery.add')}}" title="click to Add New Row" class="btn1 btn btn-primary my-auto ms-auto add">
              ...
              <table class="table table1" id="example">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="d-flex">
                        <a href="{{route('gallery.edit',$record->id)}}" title="click to Edit" class="text-info"><span class="fa fa-pencil"></span></a>&nbsp;
                        <a href="{{route('gallery.delete',$record->id)}}" title="click to Delete" class="text-danger"><span class="fa fa-trash"></span></a>
                      </div>
                    </td>
                  </tr>
                  @endforeach
