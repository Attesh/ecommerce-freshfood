        ...
        <div class="col-lg-12">
          <div class="card">
            ...
            <ul class="nav nav-tabs nav-tabs-bordered profilenav">
              ...
              <!-- Multi Columns Form -->
              <form class="row g-3" method="POST" action="{{route('city.update')}}">
			  @csrf
        <input type="hidden" name="id" value="{{$city->id}}">
                <div class="col-md-6">
                  <label for="inputState" class="form-label">Title</label>
                  <input type="text" class="form-control" id="inputName5" name="title" value="{{$city->title}}">
                </div>
</div>
<div class="tab-pane fade pt-3" id="Arabic">
<div class="col-md-6">
                  <label for="inputState" class="form-label">Title</label>
                  <input type="text" class="form-control" id="inputName5" name="title_ar" value="{{$city->title_ar}}">
                </div>
</div>
</div>
                 <div class=" mt-3">
