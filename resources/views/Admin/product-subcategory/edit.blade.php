            ...
            <div class="card-body">
              ...
              <ul class="nav nav-tabs nav-tabs-bordered profilenav">
                                    ...
                                    <div class="tab-content pt-2">
                                       ...
                                       <form class="row g-3" method="POST" action="{{route('sub.category.update')}}" enctype="multipart/form-data">
			  @csrf
        <input type="hidden" name="id" value="{{$subcategory->id}}">
                <div class="col-md-6">
                  ...
                  <option value="{{$data->id}}"{{
                    $data->id==$subcategory->category_id?'selected':''}}>{{$data->name}}</option>
                ...
                <div class="col-md-6">
                  ...
                  @foreach($category as $data)
                  <option value="{{$data->id}}"{{
                    $data->id==$subcategory->category_id?'selected':''}}>{{$data->name_ar}}</option>
                ...
                <div class="col-md-6">
                  <label for="inputState" class="form-label">SubCategory</label>
                  <input type="text" class="form-control" id="inputName5" name="title_ar" value="{{$subcategory->title_ar}}">
                </div>
                  </div>
                <div class=" mt-3">
