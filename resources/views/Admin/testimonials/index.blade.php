    ...
    <div class="pagetitle">
      ...
      <nav>
        ...
        <li class="breadcrumb-item">Management</li>
          <li class="breadcrumb-item active">Manage Testimonials</a></li>
        </ol>
      </nav>
    </div>
    <!-- End Page Title -->
                ...
                @foreach($testimonials as $key => $record)
                  <tr>
                   ...
                   <!-- <td>
                    ...
                    <td>
                       <div class="d-flex">
                        <a href="{{route('testimonials.edit',$record->id)}}"><span class="fa fa-pencil"> </span></a>&nbsp;
                        <a href="{{route('testimonials.delete',$record->id)}}"><span class="fa fa-trash text-danger"> </span></a>
                      </div>
                    </td>
                  </tr>
                  @endforeach
