          ...
          <div class="card">
            <div class="card-body">
              ...
              <ul class="nav nav-tabs nav-tabs-bordered profilenav">
                                    ...
                                    <div class="tab-content pt-2">
                                       <div class="tab-pane fade show active profile-edit pt-3" id="English">
                                        <!-- Form -->
                                        <form class="row g-3" method="POST" action="{{route('testimonials.update')}}" enctype="multipart/form-data">
			        @csrf
              <input type="hidden" name="id" value="{{$testimonials->id}}">
                <div class="col-md-6">
                  <label for="inputState" class="form-label">Name</label>
                  <input type="text" class="form-control" id="inputName5" name="name" value="{{$testimonials->name}}" required>
                </div>
              
                <div class="col-md-12">
                  <label for="inputState" class="form-label">Description</label>
                  <textarea type="text" class="form-control ckeditor" id="inputName5" name="description" required>{{$testimonials->description}}</textarea>
                </div>
                                       </div>
              ...
              <input type="hidden" name="id" value="{{$testimonials->id}}">
                <div class="col-md-6">
                  <label for="inputState" class="form-label">Name</label>
                  <input type="text" class="form-control" id="inputName5" name="name_ar" value="{{$testimonials->name_ar}}" required>
                </div>
              
                <div class="col-md-12">
                  <label for="inputState" class="form-label">Description</label>
                  <textarea type="text" class="form-control ckeditor" id="inputName5" name="description_ar" required>{{$testimonials->description_ar}}</textarea>
                </div>
</div>
</div>
                <div class="col-md-6 mt-3">
                  ...
                  <a href=""  onClick="delete(1)"><span class="fa fa-close"><img src="{{ asset('Backend/images/' . $testimonials->image) }}" id="output"  width="100" ></a>
                </div>
                <div class=" mt-3">
