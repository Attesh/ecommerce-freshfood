  ...
  <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Add Notice Board</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              <!-- <h5 class="card-title">Add Noticeboard</h5> -->

              <!-- Multi Columns Form -->
              <form class="row g-3" method="POST" action="{{route('noticeboard.store')}}" enctype="multipart/form-data">
			  @csrf
                <div class="col-md-6">
