...
<div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item">NoticeBoard</li>
          <li class="breadcrumb-item active">View NoticeBoard</li>
        </ol>
      </nav>
    </div>
   <!-- End Page Title -->
               ...
               <div class="card-body">
                  ...
                  <div class="col-lg-12">
                        <div class="d-flex justify-content-end align-items-end">
                           <a href="{{url('/admin/noticeboard')}}" class="btn btn-primary m-1 backbtnn">Back</a>
