            ...
            <div class="card-body">
              ...
              <ul class="nav nav-tabs nav-tabs-bordered profilenav">
                                    ...
                                    <div class="tab-content pt-2">
                                       ...
                                       <form class="row g-3" method="POST" action="{{route('category.update')}}" enctype="multipart/form-data">
			  @csrf
        <input type="hidden" name="id" value="{{$category->id}}">
        <div class="col-md-6">
                  <label for="inputState" class="form-label">Title</label>
                  <input type="text" class="form-control" id="inputName5" name="category_name" value="{{$category->name}}" required>
                </div>
                                       </div>
                                       <div class="tab-pane fade pt-3" id="Arabic">
                <div class="col-md-6">
                  <label for="inputState" class="form-label">Title</label>
                  <input type="text" class="form-control" id="inputName5" name="category_name_ar" value="{{$category->name_ar}}" required>
                </div>
              </div>
              <div class="row mt-3">
              <div class="col-md-6">
                  <label for="inputState" class="form-label">Icon</label>
                  <input type="text" class="form-control" id="inputName5" name="category_icon" value="{{$category->icon}}" required>
                </div>
                <div class="col-md-6">
                    ...
                    <a href=""  onClick="delete(1)"><span class="fa fa-close"><img src="{{ asset('Backend/images/' . $category->image) }}" id="output"  width="150" ></a>
                </div>
                </div>
              <div class=" mt-3">
