      ...
      <div class="col-lg-12">
        ...
        <div class="card">
          <div class="card-header d-flex">
            ...
            <a href="{{route('news.add')}}" title="click to Add New Row" class="btn1 btn btn-primary my-auto ms-auto add">
              ...
              <table class="table table1 " id="example">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <div class="d-flex">
                        <a href="{{route('news.edit',$record->id)}}"><span class="fa fa-pencil"> </span></a>&nbsp;
                        <a href="{{route('news.delete',$record->id)}}"><span class="fa fa-trash text-danger"> </span></a>
                      </div>
                    </td>
                  </tr>
                  @endforeach
